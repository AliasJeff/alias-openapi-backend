...
//        }
    ...
    public BaseResponse<Boolean> offlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        long id = idRequest.getId();
        log.info("id: {}", id);
        InterfaceInfo oldInterfaceInfo = oldInterfaceInfo = interfaceInfoService.getById(id);
        if (oldInterfaceInfo == null) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR);
        }
    ...
    public BaseResponse<Object> invokeInterface(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        String userRequestParams = interfaceInfoInvokeRequest.getUserRequestParams().trim();
